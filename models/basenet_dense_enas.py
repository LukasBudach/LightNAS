...
class BaseNetDenseEnas():
    ...
    def initialize(self, *kvargs, **kwargs):
        super().initialize(*kvargs, **kwargs)
        self.enas_sequential.initialize(*kvargs, **kwargs)

    def __getitem__(self, index):
        return self.enas_sequential[index]

    def hybrid_forward(self, F, x):
        return self.enas_sequential.hybrid_forward(F,x)

    def prune(self):
        return self.enas_sequential.prune()

    @property
    def nodeend(self):
        return self.enas_sequential.nodeend

    @property
    def nodehead(self):
        return self.enas_sequential.nodehead

    @property
    def graph(self):
        return self.enas_sequential.graph

    @property
    def kwspaces(self):
        return self.enas_sequential.kwspaces

    @property
    def nparams(self):
        return self.enas_sequential.nparams

    @property
    def latency(self):
        return self.enas_sequential.latency

    @property
    def avg_latency(self):
        return self.enas_sequential.avg_latency

    def evaluate_latency(self, x):
        return self.enas_sequential.evaluate_latency(x)

    def sample(self, **configs):
        self.enas_sequential.sample(**configs)

    def __repr__(self):
        return self.enas_sequential.__repr__()
